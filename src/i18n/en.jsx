...
export default {
  ...
  numSightingsAtLocation: '{numSpecies} bird species seen in the last {obsRecency} day(s)',
  numReported: '#',
  oldStyle: 'Old Style',
  ...
  reportBirdSightings: 'Report bird sightings',
  reportedBy: 'Reported By',
  reportSightings: 'Report Sightings',
  reportSightingsText: 'The bird sightings listed on this site come from {link}. Anyone in the world can sign up and submit their own observations. Click the button below to get started!',
