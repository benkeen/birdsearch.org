...
export default {
  ...
  autoZoom: 'Auto-zoom',
  autoZoomSetting: 'This setting controls how the map should behave after a search. {autoZoom} sets the zoom level based on your search. {showFullSearch} zooms out to show the full search boundary.',
  birds: 'birds',
