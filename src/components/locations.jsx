...
export class LocationsPanel extends React.Component {
			...
			<table className="table table-striped">
				...
				<tr>
					<th className="location"
						onClick={() => dispatch(actions.sortLocations(C.LOCATION_SORT.FIELDS.LOCATION))}>
						<FormattedMessage id="location"/>{this.getLocationColSort()}
					</th>
					<th className="capitalize"
						onClick={() => dispatch(actions.sortLocations(C.LOCATION_SORT.FIELDS.SPECIES))}>
	...
	getClearLocationFilterIcon() {
		...
		<span className="clear-filter-icon glyphicon glyphicon-remove"
			  onClick={() => dispatch(actions.setLocationFilter(''))}/>
		);
	}
				...
				<div id="locations-panel-content" ref="panel">
					<div>
						...
						<footer style={footerStyle}
								onClick={() => dispatch(actions.togglePanelVisibility(C.PANELS.LOCATIONS))}>
