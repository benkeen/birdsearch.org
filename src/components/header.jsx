...
class Header extends React.Component {
	...
	render() {
		...
		const reportSightingsTooltip = <Tooltip id="report-sightings-tooltip"><FormattedMessage
		id="reportBirdSightings"/></Tooltip>;
			...
			<ul className="nav-items">
				...
				<li>
					<OverlayTrigger placement="bottom" overlay={reportSightingsTooltip}>
						<button className="report-sightings-icon btn btn-success"
								onClick={(e) => this.showReportSightingsOverlay(e)}>
