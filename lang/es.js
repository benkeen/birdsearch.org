define([], function() {
	...
	var L = {
		...
		about_para1: "Escribí este sitio para llenar lo que considero como una brecha en lugar visible en la funcionalidad del %1 increíble sitio.",
		about_para2: "Si usted no ha descubierto eBird aún, hágalo ahora. Es un recurso excelente para los observadores de aves, ornitólogos, educadores - cualquier persona interesada en las aves. Personas de todo el mundo presentan millones de observaciones de un año a eBird, proporcionando una gran cantidad de información para la visualización y análisis. Cuantas más personas lo utilizan, mejor será.",
		about_para3: "El problema es que la funcionalidad de búsqueda disponibles en la actualidad a través de eBird es bastante limitado. Como un observador de aves, quiero una simple descripción de alto nivel de una región: ¿dónde están los lugares de observación de aves populares? ¿Qué puntos de ceder el mayoría de los pájaros? ¿Qué rarezas están siendo avistados en mi región, y dónde? Este sitio intenta ayudar a tapar ese hueco.",
