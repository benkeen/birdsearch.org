define([], function() {
	...
	var L = {
		...
		about_para1: "Ich schrieb diese Seite zu füllen, was ich als eine eher auffällige Lücke in der Funktionalität der erstaunlichen %1 Website betrachten.",
		about_para2: "Wenn Sie nicht eBird entdeckt haben, tun Sie dies jetzt. Es ist eine tolle Ressource für Vogelbeobachter, Ornithologen, Pädagogen - jeder in Vögel interessiert. Menschen auf der ganzen Welt Millionen von Beobachtungen vorlegen ein Jahr, um eBird und bietet eine Fülle von Informationen für die Betrachtung und Analyse. Je mehr Leute es verwenden, desto besser wird es.",
		about_para3: "Das Problem ist, wird die Suchfunktionalität derzeit durch eBird ziemlich beschränkt. Als Vogelbeobachter, möchte ich eine einfache High-Level-Überblick über eine Region: Wo sind die beliebten Vogelbeobachtung Standorte? Welche Spots liefern die meisten Vögel? Welche Raritäten werden in meiner Region entdeckt, und wo? Diese Seite versucht, diese Lücke Stecker helfen.",
